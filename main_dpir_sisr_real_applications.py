...
def sisr(source_folder: list, source_result: list, denoise=3 ,scale=2, model_to_use="drunet_color"):
    ...
    testset_name = source_folder[1]               # set test set,  'set5' | 'srbsd68'
    noise_level_img = denoise                  # set noise level of image, from [3, 25], set 3 for clean image
    model_name = model_to_use # 'ircnn_color'         # set denoiser, | 'drunet_color' | 'ircnn_gray' | 'drunet_gray' | 'ircnn_color'
    sf = scale                               # set scale factor, 1, 2, 3, 4
